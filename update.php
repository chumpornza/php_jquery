<?php
    ...
    $array_push = array_push($results,$input_data);  // Returns the new number of elements in the array such as 1 2 3 ...
    ...
    for($i=0;$i<sizeof($file_decode_contents);$i++) {
        $index = $i; // integer such as  0 1 2 3 ...
        $current_data = $file_decode_contents[$index]; // dict key [{"id":8192321565,"firstname":"3","lastname":"3","nickname":"3"}]
        $array_push = array_push($results,$current_data); // Returns the new number of elements in the array such as 1 2 3 ...
    }
